...
const MySVGComponent = ({ setAuthenticated }) => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const images = [
    require('./assets/ladder.png'),
    require('./assets/lights.png'),
    require('./assets/Trolley.png'),
  ];
  ...
  const [passwordVisible, setPasswordVisible] = useState(false); // Changed variable name to `passwordVisible`
...
setMessage('Login successful.');
        ...
        const { nickname, user_id } = response.data.user;
  ...
  // console.log("armL element:", armL);
  // console.log("armR element:", armR);
  ...
  if (armR) {
    ...
    return (
      <form onSubmit={handleFormSubmit}>
        ...
        <Image className="image" source={images[currentImageIndex]} style={{ width: '50%', height: '50%', marginTop:'-50%' }} />
      </div>
  ...
  <div className="svgContainer">
    ...
    <div className="inputGroup inputGroup1">
        ...
        <input
          type={passwordVisible ? 'text' : 'password'} // Updated to use passwordVisible
          id="password"
          className="password"
